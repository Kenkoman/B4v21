...
function bow::onUse(%this, %player, %InvPosition)
{
	//check for quiver 
...
datablock ShapeBaseImageData(bowImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/bow.dts";
   PreviewFileName = "rtb/data/shapes/bricks/Previews/bow.png";
...
//Super bow- you get it from using quiver with bow
datablock ShapeBaseImageData(superBowImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/bow.dts";
   skinName = 'brown';
