...
datablock AudioProfile(pickaxeDrawSound)
{
...
//effects
datablock ParticleData(pickaxeExplosionParticle)
{
   dragCoefficient      = 5;
...
datablock ParticleEmitterData(pickaxeExplosionEmitter)
{
   ejectionPeriodMS = 7;
   periodVarianceMS = 0;
   ejectionVelocity = 8;
   ...
   particles = "pickaxeExplosionParticle";
};

datablock ExplosionData(pickaxeExplosion)
{
   //explosionShape = "";
   lifeTimeMS = 500;
   ...
   particleEmitter = pickaxeExplosionEmitter;
   particleDensity = 10;
   particleRadius = 0.2;
...
datablock ItemData(pickaxe)
{
	...
	shapeFile = "~/data/shapes/pickaxe.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
...
//function pickaxe::onUse(%this,%user)
//{
...
datablock ShapeBaseImageData(pickaxeImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/pickaxe.dts";
   PreviewFileName = "rtb/data/shapes/bricks/Previews/pickaxe.png";
   emap = true;
   cloakable = false;
...
{
	//messageAll( 'MsgClient', 'pickaxe prefired!!!');
...
{ 
	weaponDamage(%obj,%col,%this,%pos,pickaxe);
	radiusDamage(%obj,%pos,%this.damageRadius,%this.radiusDamage,pickaxe,%this.areaImpulse);
}