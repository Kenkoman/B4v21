...
//-----------------------------------------------------------------------------
datablock AudioProfile(legohorseEngineSound)
{
   filename    = "~/data/sound/vehicles/legohorse/engine_idle.wav";
...
{
   category = "Vehicles";
   shapeFile = "~/data/shapes/bricks/legohorse.dts";
   emap = true;

  // maxDamage = 1.0;
  // destroyedLevel = 0.5;

   maxSteeringAngle = 1;  // Maximum steering angle, should match animation
   ...
   massBox = "40 40 40";         // Size of box used for moment of inertia,
...
function legohorse::onCollision(%this,%obj,%col,%vec,%speed)
{
