...
//-----------------------------------------------------------------------------
datablock AudioProfile(legobikeEngineSound)
{
...
datablock WheeledVehicleTire(legobikeTire)
{
   // Tires act as springs and generate lateral and longitudinal
   // forces to move the vehicle. These distortion/spring forces
   // are what convert wheel angular velocity into forces that
   // act on the rigid body.
   shapeFile = "~/data/shapes/vehicles/legobike/wheel.dts";
   staticFriction = 4;
...
//   engineSound = legobikeEngineSound;
...
function legobike::onAdd(%this,%obj)
{
   ...
   for (%i = %obj.getWheelCount() - 1; %i >= 0; %i--) {
      %obj.setWheelTire(%i,legobikeTire);
...
function legobike::onCollision(%this,%obj,%col,%vec,%speed)
{
