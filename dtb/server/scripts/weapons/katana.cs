...
datablock ItemData(katana)
{
	...
	shapeFile = "~/data/shapes/weapons/katana.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
...
datablock ShapeBaseImageData(katanaImage)
{
   ...
   radiusDamage        = 0;
   damageRadius        = 0.5;
   damagetype          = '%1 was assassinated by %2';
   muzzleVelocity      = 50;
   velInheritFactor    = 1;
...
function katanaImage::onCharge(%this,%obj)
{
	%obj.playthread(2, spearready);
}

function katanaImage::onUnmount(%this,%obj)
{
	%obj.playthread(2, root);
	%obj.playthread(1, root);
}

function katanaImage::onFire(%this, %obj, %slot)
{
