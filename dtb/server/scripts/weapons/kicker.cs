//bullet trail
datablock ParticleData(kickerTrailParticle)
{
textureName = "~/data/shapes/weapons/plasma";
	...
	colors[1] = "1.0 0.5 0.0 0.8";
	colors[2] = "0.8 0.5 0.0 0.8";
	sizes[0] = 1.5;
	sizes[1] = 0.5;
	sizes[2] = 0.1;
};

datablock ParticleEmitterData(kickerTrailEmitter)
{
   ejectionPeriodMS = 10;
   periodVarianceMS = 0;
   ...
   particles = "kickerTrailParticle";
};
datablock ExplosionData(kickerExplosion)
{
   //explosionShape = "";
	soundProfile = kickerfireSound;
...
//projectile
datablock ProjectileData(kickerProjectile)
{
   projectileShapeName = "";
   explosion           = kickerExplosion;
   particleEmitter     = kickerTrailEmitter;
   muzzleVelocity      = 50;
...
// item //
//////////
datablock ItemData(kicker)
{
	category = "Weapon";  // Mission editor category
	className = "Tool"; // For inventory system

	 // Basic Item Properties
	shapeFile = "~/data/shapes/weapons/kicker.dts";
	skinName = 'black';
	rotate = false;
	mass = 1;
	density = 0.2;
	...
	pickUpName = 'a KineticKicker.';
	invName = "KineticKicker";
	spawnName = "Kinetic Kicker";
	image = kickerImage;
	threatlevel = "Safe";
};
...
//weapon image//
////////////////
datablock ShapeBaseImageData(kickerImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/weapons/kicker.dts";
   skinName = 'brown';
   ...
   item = kicker;
   ammo = " ";
   projectile = kickerProjectile;
   projectileType = Projectile;

   directDamage        = 0;
   radiusDamage        = 0;
   damageRadius        = 0.5;
   damagetype          = '%1 got his ass kicked by %2';
   muzzleVelocity      = 50;
   velInheritFactor    = 0;
...
function kickerProjectile::onCollision(%this,%obj,%col,%fade,%pos,%normal)
{
