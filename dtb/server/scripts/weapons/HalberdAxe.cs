datablock ItemData(halberdaxe)
{
	category = "Weapon";  // Mission editor category
	className = "Tool"; // For inventory system

	 // Basic Item Properties
	shapeFile = "~/data/shapes/weapons/HalberdAxe.dts";
	mass = 1;
	density = 0.2;
	elasticity = 0.2;
	friction = 0.6;
	...
	pickUpName = 'an axe';
	invName = "Halberd";
	image = HalberdAxeImage;
	threatlevel = "Normal";
};

addWeapon(halberdaxe);

////////////////
//weapon image//
////////////////
datablock ShapeBaseImageData(HalberdAxeImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/weapons/HalberdAxe.dts";
   emap = true;
   ...
   radiusDamage        = 0;
   damageRadius        = 0.5;
   damagetype          = '%1 was cleaved in twain by %2';
   muzzleVelocity      = 50;
   velInheritFactor    = 1;
...
function HalberdAxeImage::onPreFire(%this, %obj, %slot)
{
	%obj.playthread(2, armattack);
	%obj.parrying = 1;
}

function HalberdAxeImage::onStopFire(%this, %obj, %slot)
{	
...
function HalberdAxeImage::onFire(%this, %obj, %slot)
{
