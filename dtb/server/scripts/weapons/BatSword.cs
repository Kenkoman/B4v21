...
//weapon image//
////////////////
datablock ShapeBaseImageData(BatswordImage)
{
   // Basic Item properties
   shapeFile = "~/data/shapes/weapons/batsword.dts";
   emap = true;
   ...
   radiusDamage        = 0;
   damageRadius        = 0.5;
   damagetype          = '%1 was hacked to pieces by %2';
   muzzleVelocity      = 50;
   velInheritFactor    = 1;
...
function BatswordImage::onPreFire(%this, %obj, %slot)
{
	%obj.playthread(2, armattack);
	%obj.parrying = 1;
}

function BatswordImage::onStopFire(%this, %obj, %slot)
{	
...
function BatswordImage::onFire(%this, %obj, %slot)
{
